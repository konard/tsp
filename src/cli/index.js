 ...
 *
 * Supports:
 * - Algorithm selection: sonar, moore, u-fork, gosper, peano, sierpinski, comb, saw, koch, space-filling-tree, brute-force
...
const runAlgorithm = (algorithm, points, gridSize) => {
  switch (algorithm) {
    ...
    default:
      throw new Error(
        `Unknown algorithm: ${algorithm}. Choose from: sonar, moore, u-fork, gosper, peano, sierpinski, comb, saw, koch, space-filling-tree, brute-force`
      );
  }
};
