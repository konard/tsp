...
const translations = {
  ...
  hi: {
    ...
    sierpinskiTitle: 'सिएरपिंस्की वक्र एल्गोरिदम',
    sierpinskiAliases:
      'इसे यह भी कहते हैं: स्पेस-फिलिंग वक्र, सिएरपिंस्की वर्ग वक्र',
    bruteForceTitle:
    ...
    sonarVisit:
      '\u0938\u094B\u0928\u093E\u0930 \u0935\u093F\u091C\u093C\u093F\u091F',
    mooreCurve: '\u092E\u0942\u0930 \u0935\u0915\u094D\u0930',
    sierpinskiCurve: 'सिएरपिंस्की वक्र',
  ...
  es: {
    ...
    sierpinskiAliases:
      'También conocido como: Curva de Llenado Espacial, Curva Cuadrada de Sierpiński',
  ...
  ar: {
    ...
    sierpinskiTitle: 'خوارزمية منحنى سيربنسكي',
    sierpinskiAliases:
      'يعرف أيضاً باسم: منحنى ملء الفضاء، منحنى سيربنسكي المربع',
    bruteForceTitle:
    ...
    sierpinskiCurve: 'منحنى سيربنسكي',
  ...
  bn: {
    ...
    sierpinskiAliases:
      'এটি এও পরিচিত: স্পেস-ফিলিং বক্র, সিয়েরপিনস্কি বর্গ বক্র',
    bruteForceTitle:
  ...
  ru: {
    ...
    sierpinskiAliases:
      'Также известен как: Кривая заполнения пространства, Квадратная кривая Серпинского',
    bruteForceTitle:
  ...
  pa: {
    ...
    sierpinskiTitle: 'ਸਿਏਰਪਿੰਸਕੀ ਵਕਰ ਐਲਗੋਰਿਦਮ',
    sierpinskiAliases: 'ਇਸਨੂੰ ਇਹ ਵੀ ਕਹਿੰਦੇ ਹਨ: ਸਪੇਸ-ਫਿਲਿੰਗ ਵਕਰ',
    bruteForceTitle:
      '\u0A2C\u0A4D\u0A30\u0A42\u0A1F-\u0A2B\u0A4B\u0A30\u0A38 \u0A10\u0A32\u0A17\u0A4B\u0A30\u0A3F\u0A26\u0A2E',
    bruteForceAliases:
    ...
    sonarVisit:
      '\u0A38\u0A4B\u0A28\u0A3E\u0A30 \u0A35\u0A3F\u0A1C\u0A3C\u0A3F\u0A1F',
    mooreCurve: '\u0A2E\u0A42\u0A30 \u0A35\u0A15\u0A30',
    sierpinskiCurve: 'ਸਿਏਰਪਿੰਸਕੀ ਵਕਰ',
  ...
  jv: {
    ...
    sierpinskiAliases:
      'Uga dikenal minangka: Space-Filling Curve, Kurva Kotak Sierpiński',
  ...
  ko: {
    ...
    sierpinskiAliases: '다른 이름: 공간 채움 곡선, 시에르핀스키 정사각 곡선',
  ...
  fr: {
    ...
    sierpinskiAliases:
      'Également connu sous: Courbe de Remplissage, Courbe Carrée de Sierpiński',
  ...
  te: {
    ...
    sierpinskiTitle: 'సిర్పిన్స్కీ కర్వ్ అల్గోరిదం',
    sierpinskiAliases: 'ఇతర పేర్లు: స్పేస్-ఫిల్లింగ్ కర్వ్',
    bruteForceTitle:
    ...
    sierpinskiCurve: 'సిర్పిన్స్కీ కర్వ్',
    bruteForce:
      '\u0C2C\u0C4D\u0C30\u0C42\u0C1F\u0C4D-\u0C2B\u0C4B\u0C30\u0C4D\u0C38\u0C4D',
    centroid: '\u0C15\u0C47\u0C02\u0C26\u0C4D\u0C30\u0C15\u0C02',
    modifiedEdge:
  ...
  mr: {
    ...
    sierpinskiTitle: 'सिएरपिंस्की वक्र अल्गोरिदम',
    sierpinskiAliases: 'याला असेही म्हणतात: स्पेस-फिलिंग वक्र',
    bruteForceTitle:
  ...
  tr: {
    ...
    sierpinskiAliases:
      'Ayrıca bilinen: Alan Doldurma Eğrisi, Sierpiński Kare Eğrisi',
  ...
  ta: {
    ...
    sierpinskiTitle: 'சிர்பின்ஸ்கி வளைவு அல்காரிதம்',
    sierpinskiAliases: 'மற்ற பெயர்கள்: வெளி நிரப்பு வளைவு',
    bruteForceTitle:
    ...
    sierpinskiCurve: 'சிர்பின்ஸ்கி வளைவு',
    bruteForce:
      '\u0BAA\u0BCD\u0BB0\u0BC2\u0B9F\u0BCD-\u0BAA\u0BCB\u0BB0\u0BCD\u0B9A\u0BCD',
    centroid:
      '\u0BAE\u0BC8\u0BAF\u0BAA\u0BCD\u0BAA\u0BC1\u0BB3\u0BCD\u0BB3\u0BBF',
  ...
  vi: {
    ...
    sierpinskiAliases:
      'Còn gọi là: Đường cong Lấp Đầy, Đường cong Vuông Sierpiński',
  ...
  it: {
    ...
    sierpinskiAliases:
      'Noto anche come: Curva di Riempimento Spaziale, Curva Quadrata di Sierpiński',
